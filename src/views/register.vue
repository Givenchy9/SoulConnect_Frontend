    ...
    <div class="wizard-form max-w-2xl mx-auto backdrop-blur shadow-lg rounded-lg p-6 mt-10 text-white">
      ...
      <form v-if="currentStep === 1" @submit.prevent="nextStep" class="mt-6">
        ...
        <div class="mt-4">
          ...
          <input
            ...
            class="w-full p-2 border border-gray-300 rounded-lg text-white"
          />
        </div>
  
        <button
          type="submit"
          class="w-full mt-6 py-2 bg-koranje font-bold rounded-lg hover:bg-doranje"
        >
          Volgende
        </button>
      </form>
      ...
      <form v-if="currentStep === 2" @submit.prevent="nextStep" class="mt-6">
        ...
        <div class="flex justify-between mt-6">
          ...
          <button
            type="submit"
            class="px-6 py-2 bg-koranje font-bold rounded-lg hover:bg-doranje"
          >
            Volgende
          </button>
        </div>
